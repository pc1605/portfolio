  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Full-time positions & Freelance projects
            </p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div className="w-full">
            ...
            <div className="text-muted-foreground grid grid-cols-1 gap-y-1 text-sm sm:grid-cols-2">
              ...
              <ul className="list-disc pl-4">
                <li>Java, Python, Git/GitHub</li>
                <li>RESTful APIs, Unix/Linux</li>
                <li>Figma, Canva</li>
      ...
      <div className="mt-8">
        ...
        <p className="text-foreground text-sm">
          Looking for challenging mobile & web development opportunities where I
          can leverage my React Native and full-stack skills. <br />
          Ready to contribute to innovative projects and build solutions that
          make a real impact. I'm a quick learner, hard worker, and HUNGRYYYYY
          🔥
        </p>
      </div>
